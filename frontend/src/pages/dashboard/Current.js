...
export default function Current() {
  ...
  return (
    <>
      <NavWrap>
        <NavTab  activeClassName="active" exact to="/current/requests/" count={5}>
          Request
        </NavTab>
        <NavTab activeClassName="active" exact to="/current/donations/" >
          Donations
        </NavTab>
      </NavWrap>

      <Route exact path="/current/requests/">
        <Requests />
      </Route>

      <Route exact path="/current/donations/">
        <Donations />
      </Route>
    </>
  );
